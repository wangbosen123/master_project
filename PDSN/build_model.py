...
class PDSN_model(Model):
    def __init__(self):
        ...
        ### Cls for Reg mnist
        self.flatten = Flatten(trainable=False)
        self.NN1 = Dense(128, kernel_initializer='glorot_normal', activation='sigmoid',trainable=False)
        self.dropout = Dropout(0.3,trainable=False)
        self.NN2 = Dense(10, kernel_initializer='glorot_normal', activation='softmax',trainable=False)
